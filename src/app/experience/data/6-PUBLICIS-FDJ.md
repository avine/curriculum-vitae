...
La FDJ (Française des Jeux), opérateur national de jeux de loterie, fait face à une **architecture legacy complexe et coûteuse** : 3 applications distinctes (coquille PHP + 2 apps Angular) réparties dans 3 dépôts Git, générant duplication de code, difficultés de maintenance et lenteur de déploiement. **Mission stratégique : migration vers une architecture moderne unifiée avec Server-Side Rendering.**
...
**Implémentation SSR (Server-Side Rendering) :** mise en place d'**Angular Universal** avec backend Express.js | **Amélioration du score Lighthouse** (Performance, SEO)
